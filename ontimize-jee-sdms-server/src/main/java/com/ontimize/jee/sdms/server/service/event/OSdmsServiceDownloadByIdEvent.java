...
public class OSdmsServiceDownloadByIdEvent implements IOSdmsEvent {

    private final Serializable id;
    private final OSdmsRestDataDto data;

    public OSdmsServiceDownloadByIdEvent( final Serializable id, final OSdmsRestDataDto data ) {
        this.id = id;
        this.data = data;
    }
    ...
    public String toString(){
        return new StringBuilder( "OSdmsServiceDownloadByIdEvent{" )
