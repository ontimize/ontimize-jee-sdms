...
public class S3RepositoryMoveAllEvent implements IOSdmsEvent {
    ...
    public S3RepositoryMoveAllEvent( final List<ListObjectsRequest> requests, final String bucket, final String prefix, final String currentPrefix ) {
    ...
    public String toString(){
        return new StringBuilder( "S3RepositoryMoveAllEvent{" )
