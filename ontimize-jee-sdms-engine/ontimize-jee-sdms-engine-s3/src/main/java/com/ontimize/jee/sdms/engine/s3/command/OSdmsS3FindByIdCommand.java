...
/**
 * Command to find an object by id in S3
 */
public class OSdmsS3FindByIdCommand implements IOSdmsCommand {
...
// ------------------------------------------------------------------------------------------------------------------ \\
    ...
    public OSdmsS3FindByIdCommand(final String id, final OSdmsS3InputFilter filter, final OSdmsS3InputData data ) {
        this.id = id;
        this.filter = filter;
        this.data = data;
    }
...
// ------------------------------------------------------------------------------------------------------------------ \\
    ...
    public void run() {
        ...
        this.response = this.repository.find( request );
    }
...
// ------------------------------------------------------------------------------------------------------------------ \\
    ...
    public EntityResult response() {
        if( this.response != null ) {
            ...
            if ( data.isEmpty() || data.size() > 1 || !data.get(0).getKey().equals( this.key )) {
