...
/**
 * Command to move S3 objects to another prefix.
 */
public class OSdmsS3MoveCommand implements IOSdmsCommand {
    ...
    private static final String MESSAGE_ERROR_NO_DESTINATION = "The prefix from which the action is performed in order to move the resources has not been found.";
    ...
    private static final String MESSAGE_ERROR_NO_CURRENT_PREFIX = "The current prefix to move the resources has not been found.";
